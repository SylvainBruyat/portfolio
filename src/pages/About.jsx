  ...
  return (
    <main className="about">
      ...
      <section className="about__section">
        <div className="about__width-limiter">
          <p>
            Hello, je m'appelle{' '}
      ...
      <section className="about__section about__section--tertiary-background">
        <div className="about__width-limiter about__width-limiter--reverse-flow">
          ...
          <div className="about__content">
            ...
            <p>
              Effectivement, j’ai démissionné d’un CDI avec 10 ans d’ancienneté
              et j’ai mis fin à{' '}
            ...
            <p>
              ...
              parti vivre et travailler au Japon en 2016, avant de poursuivre
              vers les États-Unis en 2017 quand mon emploi a traversé le
              Pacifique. Et c’est donc après un retour en France non-choisi en
              2020 (merci le Covid) que j’ai décidé de tout changer. Encore une
              fois.
            </p>
            <p>
              Vous en savez maintenant un peu plus sur mon parcours, mais en
        ...
        <div className="about__width-limiter">
          ...
          <div className="about__content">
            ...
            <p>
              ...
              pour vivre et travailler sur 3 continents différents en l’espace
              de 2 ans.
            </p>
            <p>
            ...
            <p>
              ...
              <span className="text-emphasis">tests d’intégration</span> sont
              très familiers pour moi.
            </p>
          </div>
        </div>
      </section>
      <section className="about__section about__section--tertiary-background">
        <div className="about__width-limiter about__width-limiter--reverse-flow">
          ...
          <div className="about__content">
            ...
            <p>
              Et puisqu’on parle de logiciels, parlons un peu technique. Le
              choix de devenir développeur web n’est pas dû au hasard.
            </p>
            <p>
            ...
            <p>
              ...
              pressurisation de la cabine, détection et extinction incendie,
              etc.
            </p>
            <p>
              Alors au moment de{' '}
            ...
            <p>
              TypeScript, PHP et SQL viendront très bientôt s'ajouter à la
              liste.
            </p>
            <p>
              <span className="text-emphasis text-emphasis--dark">
            ...
            <p>
              ...
              et au{' '}
              <span className="text-emphasis text-emphasis--dark">SEO</span> sur
              tous mes projets.
            </p>
          </div>
        </div>
